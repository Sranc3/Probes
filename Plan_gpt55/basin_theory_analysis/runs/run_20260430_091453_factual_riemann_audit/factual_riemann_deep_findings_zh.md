...
| `pure_correct_vs_wrong` | `all_no_leak` | `0.823` | `0.742` | `1085` |
...
| `rescue_vs_damage` | `all_no_leak` | `0.740` | `0.711` | `123` |
...
| `stable_correct_vs_hallucination` | `all_no_leak` | `0.687` | `0.664` | `350` |
...
| `riemann_anisotropy` | `0.2736` | `0.0796` | `0.634` | `0.614` |
...
- 如果二者提升有限，说明当前 verifier/proxy 还不够强，下一步应改进 factual verifier prompt 或使用专门 NLI/factuality model。
