...
| `pure_correct_vs_wrong` | `all_no_leak` | `0.821` | `0.749` | `1085` |
| `pure_correct_vs_wrong` | `factual_plus_riemann` | `0.784` | `0.746` | `1085` |
| `pure_correct_vs_wrong` | `riemann_geometry` | `0.764` | `0.754` | `1085` |
| `pure_correct_vs_wrong` | `strong_verifier_controller` | `0.763` | `0.733` | `1085` |
| `pure_correct_vs_wrong` | `qwen_structured_factual` | `0.702` | `0.618` | `1085` |
...
| `rescue_vs_damage` | `all_no_leak` | `0.728` | `0.661` | `123` |
| `rescue_vs_damage` | `factual_riemann_delta` | `0.716` | `0.671` | `123` |
| `rescue_vs_damage` | `strong_verifier_controller` | `0.708` | `0.720` | `123` |
| `rescue_vs_damage` | `qwen_structured_factual` | `0.701` | `0.678` | `123` |
| `rescue_vs_damage` | `qwen_factual` | `0.684` | `0.627` | `123` |
| `rescue_vs_damage` | `factual_plus_riemann` | `0.652` | `0.617` | `123` |
...
| `stable_correct_vs_hallucination` | `strong_verifier_controller` | `0.687` | `0.610` | `350` |
| `stable_correct_vs_hallucination` | `all_no_leak` | `0.675` | `0.655` | `350` |
...
| `stable_correct_vs_hallucination` | `qwen_structured_factual` | `0.606` | `0.515` | `350` |
