...
- Answer-changing rows: `75` (`7.12%`)
- Changed-case composition: corrected `4`, damaged `1`, changed-but-correct `1`, wrong-to-wrong `69`
- Evaluator warning: `4/4` corrected cases have no contains-match and need manual review.
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `phase1a_fixed_iti_recheck` | `cand008_primary` | `default` | `155` | `7.10%` | `0` | `0` | `1` | `9` | `13.56` | `-0.0078` | `-0.0016` | `0.262` |
| `phase1a_fixed_iti_recheck` | `ind0067_safety_pareto` | `default` | `155` | `5.16%` | `1` | `1` | `0` | `7` | `13.43` | `0.0218` | `-0.0014` | `0.183` |
| `phase1b_gate_ablation` | `cand008_primary` | `always` | `93` | `8.60%` | `0` | `0` | `0` | `8` | `45.38` | `-0.0080` | `0.0031` | `0.446` |
| `phase1b_gate_ablation` | `cand008_primary` | `prev_entropy_q50` | `93` | `8.60%` | `0` | `0` | `0` | `8` | `20.97` | `-0.0175` | `0.0045` | `0.490` |
| `phase1b_gate_ablation` | `cand008_primary` | `prev_entropy_q67` | `93` | `7.53%` | `0` | `0` | `0` | `7` | `13.20` | `-0.0237` | `0.0004` | `0.406` |
| `phase1b_gate_ablation` | `cand008_primary` | `prev_entropy_q80` | `93` | `7.53%` | `0` | `0` | `0` | `7` | `8.00` | `-0.0205` | `0.0004` | `0.427` |
| `phase1b_gate_ablation` | `ind0067_safety_pareto` | `always` | `93` | `10.75%` | `1` | `1` | `0` | `9` | `45.68` | `0.0515` | `-0.0019` | `0.298` |
| `phase1b_gate_ablation` | `ind0067_safety_pareto` | `prev_entropy_q50` | `93` | `7.53%` | `1` | `1` | `0` | `6` | `20.65` | `0.0201` | `0.0011` | `0.285` |
| `phase1b_gate_ablation` | `ind0067_safety_pareto` | `prev_entropy_q67` | `93` | `5.38%` | `1` | `1` | `0` | `4` | `13.01` | `0.0283` | `-0.0035` | `0.272` |
| `phase1b_gate_ablation` | `ind0067_safety_pareto` | `prev_entropy_q80` | `93` | `4.30%` | `0` | `0` | `0` | `4` | `7.74` | `0.0332` | `-0.0027` | `0.059` |
